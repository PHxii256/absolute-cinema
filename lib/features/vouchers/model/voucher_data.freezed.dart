...
mixin _$VoucherData {
 ...
 bool get claimed;@JsonKey(readValue: _readVoucherId) int get id;@JsonKey(readValue: _readIsPerk) bool get isPerk;@JsonKey(readValue: _readPerkMessage) String? get perkMessage;@JsonKey(readValue: _readPerkLimitation) String? get perkLimitation;@JsonKey(readValue: _readDiscountAmountType) String get discountAmountType;@JsonKey(readValue: _readDiscountAmount) int get discountAmount;@JsonKey(readValue: _readDiscountLimitType) String get discountLimitType;@JsonKey(readValue: _readDiscountLimitAmount) int get discountLimitAmount;@JsonKey(readValue: _readTheaterName) String? get theaterName;@JsonKey(readValue: _readvalidityDuration) String? get validityDuration;@JsonKey(readValue: _readMinSeats) int get minSeats;@JsonKey(readValue: _readVipOnly) bool get vipOnly;@JsonKey(readValue: _readSpecificWeekDay) String get specificWeekDay;@JsonKey(readValue: _readSpecificDate) String? get specificDate;@JsonKey(readValue: _readSpecificTimeStart) String? get specificTimeStart;@JsonKey(readValue: _readSpecificTimeEnd) String? get specificTimeEnd;
...
@useResult
$Res call({
 bool claimed,@JsonKey(readValue: _readVoucherId) int id,@JsonKey(readValue: _readIsPerk) bool isPerk,@JsonKey(readValue: _readPerkMessage) String? perkMessage,@JsonKey(readValue: _readPerkLimitation) String? perkLimitation,@JsonKey(readValue: _readDiscountAmountType) String discountAmountType,@JsonKey(readValue: _readDiscountAmount) int discountAmount,@JsonKey(readValue: _readDiscountLimitType) String discountLimitType,@JsonKey(readValue: _readDiscountLimitAmount) int discountLimitAmount,@JsonKey(readValue: _readTheaterName) String? theaterName,@JsonKey(readValue: _readvalidityDuration) String? validityDuration,@JsonKey(readValue: _readMinSeats) int minSeats,@JsonKey(readValue: _readVipOnly) bool vipOnly,@JsonKey(readValue: _readSpecificWeekDay) String specificWeekDay,@JsonKey(readValue: _readSpecificDate) String? specificDate,@JsonKey(readValue: _readSpecificTimeStart) String? specificTimeStart,@JsonKey(readValue: _readSpecificTimeEnd) String? specificTimeEnd
});
...
/// Create a copy of VoucherData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? claimed = null,Object? id = null,Object? isPerk = null,Object? perkMessage = freezed,Object? perkLimitation = freezed,Object? discountAmountType = null,Object? discountAmount = null,Object? discountLimitType = null,Object? discountLimitAmount = null,Object? theaterName = freezed,Object? validityDuration = freezed,Object? minSeats = null,Object? vipOnly = null,Object? specificWeekDay = null,Object? specificDate = freezed,Object? specificTimeStart = freezed,Object? specificTimeEnd = freezed,}) {
...
as int,discountLimitType: null == discountLimitType ? _self.discountLimitType : discountLimitType // ignore: cast_nullable_to_non_nullable
as String,discountLimitAmount: null == discountLimitAmount ? _self.discountLimitAmount : discountLimitAmount // ignore: cast_nullable_to_non_nullable
...
as String?,minSeats: null == minSeats ? _self.minSeats : minSeats // ignore: cast_nullable_to_non_nullable
...
class _VoucherData implements VoucherData {
  const _VoucherData({required this.claimed, @JsonKey(readValue: _readVoucherId) required this.id, @JsonKey(readValue: _readIsPerk) required this.isPerk, @JsonKey(readValue: _readPerkMessage) this.perkMessage, @JsonKey(readValue: _readPerkLimitation) this.perkLimitation, @JsonKey(readValue: _readDiscountAmountType) required this.discountAmountType, @JsonKey(readValue: _readDiscountAmount) required this.discountAmount, @JsonKey(readValue: _readDiscountLimitType) required this.discountLimitType, @JsonKey(readValue: _readDiscountLimitAmount) required this.discountLimitAmount, @JsonKey(readValue: _readTheaterName) this.theaterName, @JsonKey(readValue: _readvalidityDuration) this.validityDuration, @JsonKey(readValue: _readMinSeats) required this.minSeats, @JsonKey(readValue: _readVipOnly) required this.vipOnly, @JsonKey(readValue: _readSpecificWeekDay) required this.specificWeekDay, @JsonKey(readValue: _readSpecificDate) this.specificDate, @JsonKey(readValue: _readSpecificTimeStart) this.specificTimeStart, @JsonKey(readValue: _readSpecificTimeEnd) this.specificTimeEnd});
...
@override@JsonKey(readValue: _readDiscountLimitType) final  String discountLimitType;
...
@override@JsonKey(readValue: _readvalidityDuration) final  String? validityDuration;
...
/// Create a copy of VoucherData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? claimed = null,Object? id = null,Object? isPerk = null,Object? perkMessage = freezed,Object? perkLimitation = freezed,Object? discountAmountType = null,Object? discountAmount = null,Object? discountLimitType = null,Object? discountLimitAmount = null,Object? theaterName = freezed,Object? validityDuration = freezed,Object? minSeats = null,Object? vipOnly = null,Object? specificWeekDay = null,Object? specificDate = freezed,Object? specificTimeStart = freezed,Object? specificTimeEnd = freezed,}) {
