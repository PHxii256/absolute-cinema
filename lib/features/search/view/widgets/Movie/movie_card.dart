...
import 'package:flutter_application/features/home/view/pages/movie_details_page.dart';
...
class MovieCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return InkWell(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => MovieDetailsPage(data: movieData)));
      },
      child: Card(
        child: Padding(
