...
mixin _$MovieData {
 ...
 int get id; String get name; String get description;@JsonKey(name: 'duration_minutes') int get durationMinutes;@JsonKey(name: 'release_date') DateTime get releaseDate;@JsonKey(name: 'primary_language') String get primaryLanguage;@JsonKey(name: 'age_rating_min') int get ageRatingMin;@JsonKey(name: 'subtitle_languages') List<String>? get subtitleLanguage; double? get rating; String? get director;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MovieData&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.durationMinutes, durationMinutes) || other.durationMinutes == durationMinutes)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.primaryLanguage, primaryLanguage) || other.primaryLanguage == primaryLanguage)&&(identical(other.ageRatingMin, ageRatingMin) || other.ageRatingMin == ageRatingMin)&&const DeepCollectionEquality().equals(other.subtitleLanguage, subtitleLanguage)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.director, director) || other.director == director));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,durationMinutes,releaseDate,primaryLanguage,ageRatingMin,const DeepCollectionEquality().hash(subtitleLanguage),rating,director);

@override
String toString() {
  return 'MovieData(id: $id, name: $name, description: $description, durationMinutes: $durationMinutes, releaseDate: $releaseDate, primaryLanguage: $primaryLanguage, ageRatingMin: $ageRatingMin, subtitleLanguage: $subtitleLanguage, rating: $rating, director: $director)';
}
...
/// Create a copy of MovieData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = null,Object? durationMinutes = null,Object? releaseDate = null,Object? primaryLanguage = null,Object? ageRatingMin = null,Object? subtitleLanguage = freezed,Object? rating = freezed,Object? director = freezed,}) {
...
class _MovieData implements MovieData {
  const _MovieData({required this.id, required this.name, required this.description, @JsonKey(name: 'duration_minutes') required this.durationMinutes, @JsonKey(name: 'release_date') required this.releaseDate, @JsonKey(name: 'primary_language') required this.primaryLanguage, @JsonKey(name: 'age_rating_min') required this.ageRatingMin, @JsonKey(name: 'subtitle_languages') final  List<String>? subtitleLanguage = const [], this.rating, this.director}): _subtitleLanguage = subtitleLanguage;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MovieData&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.durationMinutes, durationMinutes) || other.durationMinutes == durationMinutes)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.primaryLanguage, primaryLanguage) || other.primaryLanguage == primaryLanguage)&&(identical(other.ageRatingMin, ageRatingMin) || other.ageRatingMin == ageRatingMin)&&const DeepCollectionEquality().equals(other._subtitleLanguage, _subtitleLanguage)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.director, director) || other.director == director));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,durationMinutes,releaseDate,primaryLanguage,ageRatingMin,const DeepCollectionEquality().hash(_subtitleLanguage),rating,director);
...
/// Create a copy of MovieData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = null,Object? durationMinutes = null,Object? releaseDate = null,Object? primaryLanguage = null,Object? ageRatingMin = null,Object? subtitleLanguage = freezed,Object? rating = freezed,Object? director = freezed,}) {
